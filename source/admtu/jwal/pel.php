...
if (empty($tapelkd))
	...
	[<a href="jadwal_prt.php?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'" title="Print PDF. . ."><img src="'.$sumber.'/img/print.gif" width="16" height="16" border="0"></a>].
	...
	do
		...
		do
			...
			if ($tdte != 0)
				...
				<br>
				[<a href="pel_entry.php?s=edit&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'"><img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>].
				 -
				[<a href="'.$filenya.'?s=hapus&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'"><img src="'.$sumber.'/img/delete.gif" width="16" height="16" border="0"></a>].
				</td>';
				}
			else
				{

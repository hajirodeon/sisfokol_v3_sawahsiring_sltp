...
if (empty($tapelkd))
	...
	{
	//query
	$qjw = mysql_query("SELECT jadwal.*, jadwal.kd AS jkd, m_guru_mapel.*, m_guru.*, ".
							"m_mapel.*, m_kelas.*, m_ruang.*, m_hari.*, m_jam.* ".
							...
							"m_ruang.ruang ASC, m_mapel.pel ASC, ".
							"m_hari.no ASC, m_jam.jam ASC");

...
if (empty($tapelkd))
	...
	<td width="150" valign="top"><strong>Uang</strong></td>
	...
	<td valign="top">
	Rp.	<input name="nil_gdg" type="text" size="10" value="'.$gdg_nilai.'" style="text-align:right" onKeyPress="return numbersonly(this, event)">,00
	</td>
	</tr>';
	...
	<td valign="top">
	Rp.	<input name="nil_uji" type="text" size="10" value="'.$uji_nilai.'" style="text-align:right" onKeyPress="return numbersonly(this, event)">,00
	</td>
	</tr>';
	...
	<td valign="top">
	Rp.	<input name="nil_spp" type="text" size="10" value="'.$spp_nilai.'" style="text-align:right" onKeyPress="return numbersonly(this, event)">,00
	</td>
	</tr>';
	...
	<td valign="top">
	Rp.	<input name="nil_lain" type="text" size="10" value="'.$lain_nilai.'" style="text-align:right" onKeyPress="return numbersonly(this, event)">,00
	</td>
	</tr>

...
function Header()
{
	...
	$this->SetY(10);
	$this->Cell(30,5,'Nama Sekolah ',0,1,'L');

	$this->SetY(15);
	$this->Cell(30,5,'Alamat',0,1,'L');

	$this->SetY(20);
	$this->Cell(30,5,'Kelas',0,1,'L');
	...
	$this->SetY(20);
	$this->SetX(50);
	$this->Cell(80,5,': '.$kelas.'',0,1,'L');

	$this->SetY(10);
	$this->SetX(140);
	$this->Cell(40,5,'Tahun Pelajaran ',0,1,'L');
	...
	//garis
	$this->WriteHTML('<table width="600"><tr><td width="600"><hr></td></tr></table>');

	if ($this->PageNo() == 1)
		{
		$this->SetFont('Times','B',14);
		$this->WriteHTML('<table>'.
							'<tr><td width="750" ALIGN="CENTER">KEUANGAN SISWA : UANG LAIN-LAIN</td></tr>'.
							'</table>');
		}

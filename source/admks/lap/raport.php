...
if (empty($tapelkd))
	...
	if ($count != 0)
		...
		do
			...
			<td>'.$nama.'</td>
			<td>
			[<a href="raport_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&skkd='.$skkd.'" target="_blank" title="Lihat Raport..."><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
			</td>
			</tr>';
	  		}

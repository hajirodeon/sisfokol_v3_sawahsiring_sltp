...
if (empty($tapelkd))
	...
	$sqlcount = "SELECT m_siswa.*, m_siswa.kd AS mskd, siswa_uang_gedung.*, ".
	...
	if ($count != 0)
		...
		<tr>
		<td>[<a href="u_siswa_gedung_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
		</td>

...
for ($i=1;$i<=12;$i++)
	...
	if ($i<=6) //bulan juli sampai desember
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&'.
			'rukd='.$rukd.'&swkd='.$swkd.'&skkd='.$skkd.'&ubln='.$ibln.'&uthn='.$pel_thn1.'">'.$arrbln[$ibln].' '.$pel_thn1.'</option>';
		}
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&'.
			'rukd='.$rukd.'&swkd='.$swkd.'&skkd='.$skkd.'&ubln='.$ibln.'&uthn='.$pel_thn2.'">'.$arrbln[$ibln].' '.$pel_thn2.'</option>';
		}
	}
